...
defined as follows.
    ...
    get(key)   : returns the value of the key if it already exists 
    in the cache otherwise returns -1.
    set(key, value) : if the key is already present, update its value
    . If not present, add the key-value pair to the cache. If the cache
    reaches its capacity it should invalidate the least recently used 
    item before inserting the new item.
    In the constructor of the class the capacity of the cache should 
    be intitialized.
...
Your Task:
You don't need to read input or print anything . Complete the constructor 
and get(), set() methods of the class LRUcache. 
...
class LRUCache
{
    ...
    public static int get(int key)
    {
        ...
        // instead of moving recently used element to front,
        // it moves to back
    ...
    public static void set(int key, int value)
    {
        ...
        // if already present then update and move to back
        if(cache.containsKey(key)){
            cache.remove(key);
        }
