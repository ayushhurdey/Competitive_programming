...
encode that returns the run length encoded string for 
the given string.
...
takes only one argument the string which is to be encoded 
...
Your Task:
Complete the function encode() which takes a character array 
as a input parameter and returns the encoded string.
